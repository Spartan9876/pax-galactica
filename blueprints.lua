...
fighter = game.make_blueprint('fighter',
  {'transform'},
  {'sprite'},
  {'collision', collision_type='ship', poly=collision.make_rectangle(14, 12)},
  {'ship', turn_speed=0.1, accel=0.2, hit_points=25, sprites_table="fighter_sprites"},
  {'fighter_shooting'},
  {'fighter_ai'})
...
frigate = game.make_blueprint('frigate',
  ...
  {'ship', turn_speed=0.02, accel=0.03, hit_points=900, sprites_table="frigate_sprites"},
  {'frigate_shooting'},
  {'frigate_ai'})
...
laser = game.make_blueprint('laser',
  ...
  {'collision', collision_type='bullet', damage=8, poly=collision.make_rectangle(32, 1)},
  {'bullet'})
